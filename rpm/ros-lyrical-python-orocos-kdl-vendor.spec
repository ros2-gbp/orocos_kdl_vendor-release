...
%global pkg_name python_orocos_kdl_vendor
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-python-orocos-kdl-vendor
Version:        0.8.0
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Jacob Perron <jacob@openrobotics.org> - 0.8.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Jacob Perron <jacob@openrobotics.org> - 0.8.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Jacob Perron <jacob@openrobotics.org> - 0.8.0-1
- Autogenerated by Bloom
