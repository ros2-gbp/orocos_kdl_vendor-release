## orocos_kdl_vendor (jazzy) - 0.5.2-1

The packages in the `orocos_kdl_vendor` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy orocos_kdl_vendor` on `Tue, 02 Jun 2026 06:21:47 -0000`
...
## orocos_kdl_vendor (rolling) - 0.8.0-1

The packages in the `orocos_kdl_vendor` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release orocos_kdl_vendor -r rolling` on `Sat, 26 Apr 2025 00:10:07 -0000`
...
## orocos_kdl_vendor (kilted) - 0.7.1-1

The packages in the `orocos_kdl_vendor` repository were released into the `kilted` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release orocos_kdl_vendor -r kilted` on `Sat, 26 Apr 2025 00:09:05 -0000`
...
## orocos_kdl_vendor (rolling) - 0.7.0-1

The packages in the `orocos_kdl_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling orocos_kdl_vendor` on `Wed, 20 Nov 2024 16:00:38 -0000`
...
## orocos_kdl_vendor (rolling) - 0.6.1-1

The packages in the `orocos_kdl_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling orocos_kdl_vendor` on `Mon, 17 Jun 2024 14:31:24 -0000`
...
The packages in the `orocos_kdl_vendor` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release orocos_kdl_vendor --rosdistro jazzy` on `Mon, 13 May 2024 19:53:38 -0000`
...
The packages in the `orocos_kdl_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling orocos_kdl_vendor` on `Thu, 09 Jun 2022 16:43:57 -0000`
